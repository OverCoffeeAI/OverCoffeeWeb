...
const OverCoffeeLanding: FC = () => {
  ...
  const features: FeatureData[] = [
    {
      ...
      description:
        "AI-driven, empathetic conversations that help you explore feelings and find direction.",
    },
    {
      icon: "bi-journal-text",
      title: "Reflective Journaling",
      description:
        "Prompts and exercises boost self-awareness—capture your thoughts in real time.",
    },
    {
      icon: "bi-emoji-smile",
      title: "Emotional Insights",
      description:
        "Personalized reports show patterns and suggest next steps for mental well-being.",
    },
  ];
  ...
  const testimonials: TestimonialData[] = [
    {
      quote:
        "It feels like talking to a close friend. It's a useful tool for the overthinker like myself.",
      author: "Evin J.",
      title: "College Student",
    },
    {
      quote:
        "I love the weekly reflection feature—it keeps me grounded, especially during stressful exam weeks.",
      author: "Michaela N.",
      title: "Graduate Student",
    },
    {
      quote:
        "The insights report gave me a clearer picture of my goals and feelings. Highly recommend!",
      author: "Emily R.",
      ...
      <div data-bs-spy="scroll" data-bs-target=".navbar">
        ...
        <nav className="navbar fixed-top navbar-expand-lg bg-white shadow-sm">
          <div className="container-fluid">
            <a className="navbar-brand d-flex align-items-center" href="#home">
              <img src={logo} alt="Over Coffee Logo" width="50" height="50" />
        ...
        >
          <div className="container text-center">
            ...
            <a href="#features" className="btn btn-brand btn-lg">
              Learn More
            </a>
          </div>
        </section>
        ...
        <section id="about" className="py-5">
          <div className="container">
            ...
            <div className="row align-items-center g-4">
              ...
              <div className="col-md-6">
                <p>
                  We believe introspection shouldn't feel overwhelming. Over
                  Coffee simplifies self-exploration into bite-size, daily
                  prompts and empathetic chat sessions. Whether you're juggling
                  coursework, part-time work, or new challenges, Over Coffee
                  meets you where you are—no judgment, only guidance.
                </p>
                <p>
                  Our mission is to foster mental-health awareness, encourage
                  honest reflection, and help you connect with your true
                  motivations—all through a friendly, conversational interface.
                </p>
              </div>
            </div>
          </div>
